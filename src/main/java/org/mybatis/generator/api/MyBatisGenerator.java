...
System.out.println("callback:"+new Gson().toJson(callback));
        System.out.println("contextIds:"+new Gson().toJson(contextIds));
        System.out.println("fullyQualifiedTableNames:"+new Gson().toJson(fullyQualifiedTableNames));
        ...
        for (GeneratedXmlFile gxf : generatedXmlFiles) {
            ...
            System.out.println("gxf:"+new Gson().toJson(gxf.getTargetProject()));
            File targetFile;
            String source;
            try {
                ...
                if (targetFile.exists()) {
                    if (gxf.isMergeable()) {
                        ...
                        System.out.println("生成daoxml:"+new Gson().toJson(gxf.getFormattedContent()));
